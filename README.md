...
- `6.7-interferometer-telescopes-2.ipynb` — 多望远镜 21 cm IM f_NL Fisher 预报（解析 + mock z 对齐；支持 `bf.KMIN_EFF`/`bf.KMAX_EFF` k 窗口旋钮）
- `fisher_1.3.2.1_DirctTF_GenNoise_AssisHKL_Tutorial.ipynb` — Fisher 教程
